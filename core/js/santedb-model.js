...
var SanteDBModel = {
    ...
    // SanteDB.Core.Model.Security.SecurityDevice, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Security.SecurityEntity, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
     ...
     * @property {uuid} id            The internal primary key value of the entity            
     * @property {string} $type            Gets the type            
     * @param {SanteDBModel.SecurityEntity} copyData Copy constructor (if present)
     */
    ...
    // SanteDB.Core.Model.Security.SecurityPolicy, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Security.SecurityPolicyInstance, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
     ...
     * @property {date} modifiedOn
     * @property {uuid} source
     * @property {SanteDBModel.SecurityEntity} sourceModel [Delay loaded from source], 
     * @property {uuid} id            The internal primary key value of the entity            
     * @property {string} $type            Gets the type            
    ...
    // SanteDB.Core.Model.Security.SecurityRole, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
     ...
     * @property {uuid} id            The internal primary key value of the entity            
     * @property {string} $type            Gets the type            
     * @param {SanteDBModel.SecurityRole} copyData Copy constructor (if present)
     */
    ...
    // SanteDB.Core.Model.Security.SecurityUser, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Roles.Patient, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
     ...
     * @property {SanteDBModel.DatePrecision} deceasedDatePrecision            Gets or sets the precision of the date of deceased            (see: {@link SanteDBModel.DatePrecision} for values)
     ...
     * @property {SanteDBModel.DatePrecision} dateOfBirthPrecision            Gets or sets the precision ofthe date of birth            (see: {@link SanteDBModel.DatePrecision} for values)
     ...
     * @property {SanteDBModel.EntityAddress} address.Alphabetic             Represents an alphabetic address used for matching             
     * @property {SanteDBModel.EntityAddress} address.BadAddress             Represents a bad address, i.e. an address which is old or invalid.            
     * @property {SanteDBModel.EntityAddress} address.Direct             Represents a workplace address that reaches the person directly without intermediaries.            
     * @property {SanteDBModel.EntityAddress} address.HomeAddress             The home address            
     * @property {SanteDBModel.EntityAddress} address.Ideographic             Represents an address expressed in an ideographic manner (example: Kaji)            
     * @property {SanteDBModel.EntityAddress} address.Phonetic             Represents an address expressed as a phonetic spelling of an ideographic address            
     * @property {SanteDBModel.EntityAddress} address.PhysicalVisit             The address is a physical place where visits should occur            
     * @property {SanteDBModel.EntityAddress} address.PostalAddress             The address is a postal address used for the delivery of mail and materials            
     * @property {SanteDBModel.EntityAddress} address.PrimaryHome             Represents a primary address to reach a contact after business hours.            
     * @property {SanteDBModel.EntityAddress} address.Public             Represents an address that is a standard address that may be subject to a switchboard or operator prior to reaching the intended entity.            
     * @property {SanteDBModel.EntityAddress} address.Soundex             Represents an address used for soundex matching purposes.            
     * @property {SanteDBModel.EntityAddress} address.Syllabic             Represents a syllabic address.            
     * @property {SanteDBModel.EntityAddress} address.TemporaryAddress             Represents a temporary address that may be good for visiting or mailing.            
     * @property {SanteDBModel.EntityAddress} address.VacationHome             Represents a vacation home to reach a person while on vacation.            
     * @property {SanteDBModel.EntityAddress} address.WorkPlace             Represents an office address, should be used for business communications            
     ...
     * @property {SanteDBModel.EntityIdentifier} identifier.classifier  where classifier is from {@link SanteDBModel.IdentifierBase} authority
     ...
     * @property {SanteDBModel.EntityName} name.Syllabic             The name represents a syllabic name.            
     ...
     * @property {SanteDBModel.EntityRelationship} relationship.Access             The access            
     * @property {SanteDBModel.EntityRelationship} relationship.ActiveMoiety             The active moiety            
     * @property {SanteDBModel.EntityRelationship} relationship.AdministerableMaterial             The administerable material            
     * @property {SanteDBModel.EntityRelationship} relationship.AdoptedChild             The adopted child            
     * @property {SanteDBModel.EntityRelationship} relationship.AdoptedDaughter             The adopted daughter            
     * @property {SanteDBModel.EntityRelationship} relationship.AdoptedSon             The adopted son            
     * @property {SanteDBModel.EntityRelationship} relationship.Affiliate             The affiliate            
     * @property {SanteDBModel.EntityRelationship} relationship.Agent             The agent            
     * @property {SanteDBModel.EntityRelationship} relationship.Aliquot             The aliquot            
     * @property {SanteDBModel.EntityRelationship} relationship.Assigned             The assigned            
     * @property {SanteDBModel.EntityRelationship} relationship.AssignedEntity             The assigned entity            
     * @property {SanteDBModel.EntityRelationship} relationship.Aunt             The aunt            
     * @property {SanteDBModel.EntityRelationship} relationship.Birthplace             The birthplace            
     * @property {SanteDBModel.EntityRelationship} relationship.Brother             The brother            
     * @property {SanteDBModel.EntityRelationship} relationship.Brotherinlaw             The brotherinlaw            
     * @property {SanteDBModel.EntityRelationship} relationship.Caregiver             The caregiver            
     * @property {SanteDBModel.EntityRelationship} relationship.CaseSubject             The case subject            
     * @property {SanteDBModel.EntityRelationship} relationship.Child             The child            
     * @property {SanteDBModel.EntityRelationship} relationship.ChildInlaw             The child inlaw            
     * @property {SanteDBModel.EntityRelationship} relationship.Citizen             The citizen            
     * @property {SanteDBModel.EntityRelationship} relationship.Claimant             The claimant            
     * @property {SanteDBModel.EntityRelationship} relationship.ClinicalResearchInvestigator             The clinical research investigator            
     * @property {SanteDBModel.EntityRelationship} relationship.ClinicalResearchSponsor             The clinical research sponsor            
     * @property {SanteDBModel.EntityRelationship} relationship.CommissioningParty             The commissioning party            
     * @property {SanteDBModel.EntityRelationship} relationship.Contact             The contact            
     * @property {SanteDBModel.EntityRelationship} relationship.Cousin             The cousin            
     * @property {SanteDBModel.EntityRelationship} relationship.CoverageSponsor             The coverage sponsor            
     * @property {SanteDBModel.EntityRelationship} relationship.CoveredParty             The covered party            
     * @property {SanteDBModel.EntityRelationship} relationship.Daughter             The daughter            
     * @property {SanteDBModel.EntityRelationship} relationship.DaughterInlaw             The daughter inlaw            
     * @property {SanteDBModel.EntityRelationship} relationship.DedicatedServiceDeliveryLocation             The dedicated service delivery location            
     * @property {SanteDBModel.EntityRelationship} relationship.Dependent             The dependent            
     * @property {SanteDBModel.EntityRelationship} relationship.DistributedMaterial             The distributed material            
     * @property {SanteDBModel.EntityRelationship} relationship.DomesticPartner             The domestic partner            
     * @property {SanteDBModel.EntityRelationship} relationship.EmergencyContact             The emergency contact            
     * @property {SanteDBModel.EntityRelationship} relationship.Employee             The employee            
     * @property {SanteDBModel.EntityRelationship} relationship.ExposedEntity             The exposed entity            
     * @property {SanteDBModel.EntityRelationship} relationship.FamilyMember             The family member            
     * @property {SanteDBModel.EntityRelationship} relationship.Father             The father            
     * @property {SanteDBModel.EntityRelationship} relationship.Fatherinlaw             The fatherinlaw            
     * @property {SanteDBModel.EntityRelationship} relationship.FosterChild             The foster child            
     * @property {SanteDBModel.EntityRelationship} relationship.FosterDaughter             The foster daughter            
     * @property {SanteDBModel.EntityRelationship} relationship.FosterSon             The foster son            
     * @property {SanteDBModel.EntityRelationship} relationship.Grandchild             The grandchild            
     * @property {SanteDBModel.EntityRelationship} relationship.Granddaughter             The granddaughter            
     * @property {SanteDBModel.EntityRelationship} relationship.Grandfather             The grandfather            
     * @property {SanteDBModel.EntityRelationship} relationship.Grandmother             The grandmother            
     * @property {SanteDBModel.EntityRelationship} relationship.Grandparent             The grandparent            
     * @property {SanteDBModel.EntityRelationship} relationship.Grandson             The grandson            
     * @property {SanteDBModel.EntityRelationship} relationship.GreatGrandfather             The great grandfather            
     * @property {SanteDBModel.EntityRelationship} relationship.GreatGrandmother             The great grandmother            
     * @property {SanteDBModel.EntityRelationship} relationship.GreatGrandparent             The great grandparent            
     * @property {SanteDBModel.EntityRelationship} relationship.Guarantor             The guarantor            
     * @property {SanteDBModel.EntityRelationship} relationship.GUARD             The guard            
     * @property {SanteDBModel.EntityRelationship} relationship.Guardian             The guardian            
     * @property {SanteDBModel.EntityRelationship} relationship.Halfbrother             The halfbrother            
     * @property {SanteDBModel.EntityRelationship} relationship.Halfsibling             The halfsibling            
     * @property {SanteDBModel.EntityRelationship} relationship.Halfsister             The halfsister            
     * @property {SanteDBModel.EntityRelationship} relationship.HealthcareProvider             The healthcare provider            
     * @property {SanteDBModel.EntityRelationship} relationship.HealthChart             The health chart            
     * @property {SanteDBModel.EntityRelationship} relationship.HeldEntity             The held entity            
     * @property {SanteDBModel.EntityRelationship} relationship.Husband             The husband            
     * @property {SanteDBModel.EntityRelationship} relationship.IdentifiedEntity             The identified entity            
     * @property {SanteDBModel.EntityRelationship} relationship.IncidentalServiceDeliveryLocation             The incidental service delivery location            
     * @property {SanteDBModel.EntityRelationship} relationship.Individual             The individual            
     * @property {SanteDBModel.EntityRelationship} relationship.InvestigationSubject             The investigation subject            
     * @property {SanteDBModel.EntityRelationship} relationship.InvoicePayor             The invoice payor            
     * @property {SanteDBModel.EntityRelationship} relationship.Isolate             The isolate            
     * @property {SanteDBModel.EntityRelationship} relationship.LicensedEntity             The licensed entity            
     * @property {SanteDBModel.EntityRelationship} relationship.MaintainedEntity             The maintained entity            
     * @property {SanteDBModel.EntityRelationship} relationship.ManufacturedProduct             The manufactured product            
     * @property {SanteDBModel.EntityRelationship} relationship.MaternalAunt             The maternal aunt            
     * @property {SanteDBModel.EntityRelationship} relationship.MaternalCousin             The maternal cousin            
     * @property {SanteDBModel.EntityRelationship} relationship.MaternalGrandfather             The maternal grandfather            
     * @property {SanteDBModel.EntityRelationship} relationship.MaternalGrandmother             The maternal grandmother            
     * @property {SanteDBModel.EntityRelationship} relationship.MaternalGrandparent             The maternal grandparent            
     * @property {SanteDBModel.EntityRelationship} relationship.MaternalGreatgrandfather             The maternal greatgrandfather            
     * @property {SanteDBModel.EntityRelationship} relationship.MaternalGreatgrandmother             The maternal greatgrandmother            
     * @property {SanteDBModel.EntityRelationship} relationship.MaternalGreatgrandparent             The maternal greatgrandparent            
     * @property {SanteDBModel.EntityRelationship} relationship.MaternalUncle             The maternal uncle            
     * @property {SanteDBModel.EntityRelationship} relationship.MilitaryPerson             The military person            
     * @property {SanteDBModel.EntityRelationship} relationship.Mother             The mother            
     * @property {SanteDBModel.EntityRelationship} relationship.Motherinlaw             The motherinlaw            
     * @property {SanteDBModel.EntityRelationship} relationship.NamedInsured             The named insured            
     * @property {SanteDBModel.EntityRelationship} relationship.NaturalBrother             The natural brother            
     * @property {SanteDBModel.EntityRelationship} relationship.NaturalChild             The natural child            
     * @property {SanteDBModel.EntityRelationship} relationship.NaturalDaughter             The natural daughter            
     * @property {SanteDBModel.EntityRelationship} relationship.NaturalFather             The natural father            
     * @property {SanteDBModel.EntityRelationship} relationship.NaturalFatherOfFetus             The natural father of fetus            
     * @property {SanteDBModel.EntityRelationship} relationship.NaturalMother             The natural mother            
     * @property {SanteDBModel.EntityRelationship} relationship.NaturalParent             The natural parent            
     * @property {SanteDBModel.EntityRelationship} relationship.NaturalSibling             The natural sibling            
     * @property {SanteDBModel.EntityRelationship} relationship.NaturalSister             The natural sister            
     * @property {SanteDBModel.EntityRelationship} relationship.NaturalSon             The natural son            
     * @property {SanteDBModel.EntityRelationship} relationship.Nephew             The nephew            
     * @property {SanteDBModel.EntityRelationship} relationship.NextOfKin             The next of kin            
     * @property {SanteDBModel.EntityRelationship} relationship.Niece             The niece            
     * @property {SanteDBModel.EntityRelationship} relationship.NieceNephew             The niece nephew            
     * @property {SanteDBModel.EntityRelationship} relationship.NotaryPublic             The notary public            
     * @property {SanteDBModel.EntityRelationship} relationship.OwnedEntity             The owned entity            
     * @property {SanteDBModel.EntityRelationship} relationship.Parent             The parent            
     * @property {SanteDBModel.EntityRelationship} relationship.ParentInlaw             The parent inlaw            
     * @property {SanteDBModel.EntityRelationship} relationship.Part             The part            
     * @property {SanteDBModel.EntityRelationship} relationship.PaternalAunt             The paternal aunt            
     * @property {SanteDBModel.EntityRelationship} relationship.PaternalCousin             The paternal cousin            
     * @property {SanteDBModel.EntityRelationship} relationship.PaternalGrandfather             The paternal grandfather            
     * @property {SanteDBModel.EntityRelationship} relationship.PaternalGrandmother             The paternal grandmother            
     * @property {SanteDBModel.EntityRelationship} relationship.PaternalGrandparent             The paternal grandparent            
     * @property {SanteDBModel.EntityRelationship} relationship.PaternalGreatgrandfather             The paternal greatgrandfather            
     * @property {SanteDBModel.EntityRelationship} relationship.PaternalGreatgrandmother             The paternal greatgrandmother            
     * @property {SanteDBModel.EntityRelationship} relationship.PaternalGreatgrandparent             The paternal greatgrandparent            
     * @property {SanteDBModel.EntityRelationship} relationship.PaternalUncle             The paternal uncle            
     * @property {SanteDBModel.EntityRelationship} relationship.Patient             The patient            
     * @property {SanteDBModel.EntityRelationship} relationship.Payee             The payee            
     * @property {SanteDBModel.EntityRelationship} relationship.PersonalRelationship             The personal relationship            
     * @property {SanteDBModel.EntityRelationship} relationship.PlaceOfDeath             The place of death            
     * @property {SanteDBModel.EntityRelationship} relationship.PolicyHolder             The policy holder            
     * @property {SanteDBModel.EntityRelationship} relationship.ProgramEligible             The program eligible            
     * @property {SanteDBModel.EntityRelationship} relationship.QualifiedEntity             The qualified entity            
     * @property {SanteDBModel.EntityRelationship} relationship.RegulatedProduct             The regulated product            
     * @property {SanteDBModel.EntityRelationship} relationship.ResearchSubject             The research subject            
     * @property {SanteDBModel.EntityRelationship} relationship.RetailedMaterial             The retailed material            
     * @property {SanteDBModel.EntityRelationship} relationship.Roomate             The roomate            
     * @property {SanteDBModel.EntityRelationship} relationship.ServiceDeliveryLocation             The service delivery location            
     * @property {SanteDBModel.EntityRelationship} relationship.Sibling             The sibling            
     * @property {SanteDBModel.EntityRelationship} relationship.SiblingInlaw             The sibling inlaw            
     * @property {SanteDBModel.EntityRelationship} relationship.SignificantOther             The significant other            
     * @property {SanteDBModel.EntityRelationship} relationship.SigningAuthorityOrOfficer             The signing authority or officer            
     * @property {SanteDBModel.EntityRelationship} relationship.Sister             The sister            
     * @property {SanteDBModel.EntityRelationship} relationship.Sisterinlaw             The sisterinlaw            
     * @property {SanteDBModel.EntityRelationship} relationship.Son             The son            
     * @property {SanteDBModel.EntityRelationship} relationship.SonInlaw             The son inlaw            
     * @property {SanteDBModel.EntityRelationship} relationship.Specimen             The specimen            
     * @property {SanteDBModel.EntityRelationship} relationship.Spouse             The spouse            
     * @property {SanteDBModel.EntityRelationship} relationship.Stepbrother             The stepbrother            
     * @property {SanteDBModel.EntityRelationship} relationship.StepChild             The step child            
     * @property {SanteDBModel.EntityRelationship} relationship.Stepdaughter             The stepdaughter            
     * @property {SanteDBModel.EntityRelationship} relationship.Stepfather             The stepfather            
     * @property {SanteDBModel.EntityRelationship} relationship.Stepmother             The stepmother            
     * @property {SanteDBModel.EntityRelationship} relationship.StepParent             The step parent            
     * @property {SanteDBModel.EntityRelationship} relationship.StepSibling             The step sibling            
     * @property {SanteDBModel.EntityRelationship} relationship.Stepsister             The stepsister            
     * @property {SanteDBModel.EntityRelationship} relationship.Stepson             The stepson            
     * @property {SanteDBModel.EntityRelationship} relationship.Student             The student            
     * @property {SanteDBModel.EntityRelationship} relationship.Subscriber             The subscriber            
     * @property {SanteDBModel.EntityRelationship} relationship.TerritoryOfAuthority             The territory of authority            
     * @property {SanteDBModel.EntityRelationship} relationship.TherapeuticAgent             The therapeutic agent            
     * @property {SanteDBModel.EntityRelationship} relationship.Uncle             The uncle            
     * @property {SanteDBModel.EntityRelationship} relationship.Underwriter             The underwriter            
     * @property {SanteDBModel.EntityRelationship} relationship.UsedEntity             The used entity            
     * @property {SanteDBModel.EntityRelationship} relationship.WarrantedProduct             The warranted product            
     * @property {SanteDBModel.EntityRelationship} relationship.Wife             The wife            
     * @property {SanteDBModel.EntityRelationship} relationship.Replaces             The replaces            
    ...
    // SanteDB.Core.Model.Roles.Provider, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
     ...
     * @memberof SanteDBModel
     * @public
     * @extends SanteDBModel.ManufacturedMaterial
     ...
     * @property {SanteDBModel.Concept} capTypeConceptModel [Delay loaded from capTypeConcept],             Gets or sets the cap type concept. The type of container cap consistent with de-capping, piercing or other automated manipulation.            
     ...
     * @property {uuid} id            The internal primary key value of the entity            
     * @property {string} $type            Gets the type            
     * @param {SanteDBModel.Container} copyData Copy constructor (if present)
     */
    ...
    // SanteDB.Core.Model.Entities.UserEntity, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.ApplicationEntity, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.DeviceEntity, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.Entity, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.EntityAddress, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.EntityAddressComponent, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.EntityName, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.EntityNameComponent, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.EntityRelationship, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.EntityTelecomAddress, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.Material, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.Organization, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
     ...
     * @property {SanteDBModel.Concept} industryConceptModel [Delay loaded from industryConcept],             Gets or sets the industry concept key            
    ...
    // SanteDB.Core.Model.Entities.Person, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.PersonLanguageCommunication, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.Place, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Entities.PlaceService, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.AssigningAuthority, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.CodeSystem, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.Concept, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
     ...
     * @property {SanteDBModel.ConceptRelationship} relationship.InverseOf             The source concept has the inverse meaning of the target concept            
     * @property {SanteDBModel.ConceptRelationship} relationship.MemberOf             The source concept is a member of the target concept            
     * @property {SanteDBModel.ConceptRelationship} relationship.NegationOf             The source concept is a negation of the target concept            
     * @property {SanteDBModel.ConceptRelationship} relationship.SameAs             The source concept has the same meaning as the target concept            
    ...
    // SanteDB.Core.Model.DataTypes.ConceptClass, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.ConceptName, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.ConceptReferenceTerm, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.ConceptRelationship, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.ConceptRelationshipType, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.ConceptSet, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
     ...
     * @property {SanteDBModel.ExtensionType} extensionTypeModel [Delay loaded from extensionType], 
     * @property {number} effectiveVersionSequence
     * @property {number} obsoleteVersionSequence
     * @property {date} modifiedOn
     * @property {uuid} source
    ...
    // SanteDB.Core.Model.DataTypes.ActExtension, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.ExtensionType, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.ActNote, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.PhoneticAlgorithm, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.ReferenceTerm, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.ReferenceTermName, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.ActTag, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.TemplateDefinition, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Collection.Bundle, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Acts.Act, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Acts.ActParticipation, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Acts.ActProtocol, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Acts.ActRelationship, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Acts.CarePlan, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
     ...
     *             
     * @property {SanteDBModel.Patient} target            Target of the careplan            
     * @property {object} act            Action to take            
     * @property {SanteDBModel.Act} act.AccountManagement             The act represents generic account management such as adjudications, financial adjustments, stock counting, etc.            
     * @property {SanteDBModel.Act} act.Act             The act represents a generic act which has no special classification            
     * @property {SanteDBModel.Act} act.Battery             The act represents a simple battery of procedures/administrations/tests/etc.            
     * @property {SanteDBModel.Act} act.CareProvision             The act represents some provision of care such as the seeking out services.            
     * @property {SanteDBModel.Act} act.Condition             The act represents a problem or condition which the patient is suffering from.            
     * @property {SanteDBModel.Act} act.ControlAct             The control act event key is used to describe an infrastructural act which has no clinical meaning but can be used to wrap technical details.            
     * @property {SanteDBModel.Act} act.Encounter             The act represents an encounter such as the patient presenting for care and receiving services during a visit.            
     * @property {SanteDBModel.Act} act.Inform             The act represents an attempt to provide additional clinical information.            
     * @property {SanteDBModel.Act} act.Observation             The act represents an observation that is made about a patient such as a vital sign, an allergy, cause of death, etc..            
     * @property {SanteDBModel.Act} act.Procedure             The act represents a procedure (something done to a patient).            
     * @property {SanteDBModel.Act} act.Registration             The act represents a registration event such as the registration of a patient.            
     * @property {SanteDBModel.Act} act.SubstanceAdministration             The act represents that a substance (medication, or otherwise) was, should, or will be administered to the patient.            
     * @property {SanteDBModel.Act} act.Supply             The act represents a supply of some material or financial instrument between entities.            
     * @property {SanteDBModel.Act} act.Transport             The physical transporting of materials or people from one place to another.            
     * @property {SanteDBModel.Act} act.$other Unclassified
     * @property {date} creationTimeModel [Delay loaded from creationTime],             Gets or sets the time at which the data was created            
     * @property {string} creationTime            Gets or sets the creation time in XML format            
     * @property {date} obsoletionTimeModel [Delay loaded from obsoletionTime],             Gets or sets the time when the data is or will become invalid            
     * @property {string} obsoletionTime            Gets or sets the creation time in XML format            
     ...
     * @property {uuid} id            The internal primary key value of the entity            
     * @property {string} $type            Gets the type            
     * @param {SanteDBModel.CarePlan} copyData Copy constructor (if present)
     */
    ...
    // SanteDB.Core.Model.Acts.QuantityObservation, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Acts.TextObservation, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Acts.CodedObservation, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Acts.PatientEncounter, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Acts.Protocol, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Acts.SubstanceAdministration, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @class
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.UserClassKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.DataTypes.DatePrecision, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.AddressUseKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.EntityClassKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.DeterminerKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.NameUseKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.ActParticipationKey, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.EntityRelationshipTypeKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.StatusKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.TelecomAddressUseKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.NameComponentKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.PhoneticAlgorithmKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.ConceptRelationshipTypeKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.ConceptClassKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.CodeSystemKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.ActClassKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.ActMoodKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.ActReasonKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.ActRelationshipTypeKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
    ...
    // SanteDB.Core.Model.Constants.NullReasonKeys, SanteDB.Core.Model, Version=0.9.7.27948, Culture=neutral, PublicKeyToken=null
    /**
     * @enum {uuid}
     * @memberof SanteDBModel
     * @public
