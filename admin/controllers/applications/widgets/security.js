 ...
 * the License.
 */
angular.module('santedb').controller('SecurityApplicationController', ["$scope", "$rootScope", "$state", "$templateCache", "$stateParams", function ($scope, $rootScope, $state, $templateCache, $stateParams) {
