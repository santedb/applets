    ...
    function _cdssCompletor() {
        ...
        const _csharpKeywords =
            [
                ...
                { name: "intf", type: "Int32", snippet: "int(\"${1:fact_name}\")", documentation: "Retrieve an Integer based fact from the context" },
                { name: "realf", type: "Double", snippet: "real(\"${1:fact_name}\")", documentation: "Retrieve a double precision decimal number fact from context" },
                { name: "boolf", type: "Boolean", snippet: "bool(\"${1:fact_name}\")", documentation: "Retrieve a boolean value fact from the context" },
                { name: "datef", type: "DateTime", snippet: "date(\"${1:fact_name}\")", documentation: "Retrieve a date value fact from the context" },
                { name: "stringf", type: "String", snippet: "string(\"${1:fact_name}\")", documentation: "Retrieve a string fact from the context" },
                { name: "data", type: "Dataset", snippet: "data(\"${1:data_name}\")", documentation: "Get a CDSS defined dataset for reference value lookup" },
                { name: "actf", type: "Act", snippet: "act(\"${1:fact_name}\")", documentation: "Retrieve an Act based fact from the context" },
                { name: "entityf", type: "Entity", snippet: "entity(\"${1:fact_name}\")", documentation: "Retrieve an Entity based fact from the context" },
